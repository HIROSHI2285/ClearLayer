...
export function Dropzone({ onDrop, className, isReady, initError }: DropzoneProps) {
    ...
    return (
        <div
            {...getRootProps()}
            className={cn(
                "relative overflow-hidden border-2 border-dashed rounded-[2rem] p-4 md:p-12 transition-all duration-300 cursor-pointer flex flex-col items-center justify-center text-center gap-6",
                isDragActive
